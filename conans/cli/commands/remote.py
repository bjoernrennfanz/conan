...
def remote_list(conan_api, parser, subparser, *args):
    ...
    info = [{"name": "remote1", "url": "https://someurl1", "ssl": True, "type": "conan_api", "enabled": False},
            {"name": "remote2", "url": "https://someurl2", "ssl": False, "type": "conan_api", "enabled": True},
            {"name": "remote3", "url": "https://someurl3", "ssl": True, "type": "conan_api", "enabled": True},
            {"name": "remote4", "url": "https://someurl4", "ssl": False, "type": "conan_api", "enabled": False},
            {"name": "remote5", "url": "https://someurl5", "ssl": False, "type": "azure_universal", "enabled": True},
            {"name": "remote6", "url": "https://someurl6", "ssl": False, "type": "azure_universal", "enabled": False}]
    return info
...
def remote_add(conan_api, parser, subparser, *args):
    ...
    subparser.add_argument("type", help="Type for the remote",
                           choices=["conan_api", "azure_universal"], default="conan_api")
...
def remote_update(conan_api, parser, subparser, *args):
    ...
    subparser.add_argument("--type", action=OnceArgument,
                           help="New type for the remote",
                           choices=["conan_api", "azure_universal"])
